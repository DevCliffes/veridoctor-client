...
export const metadata: Metadata = {
  ...
  description:
    "Answers to common questions about booking appointments, virtual consultations, doctor verification, insurance, and health records on VeriDoctor.",
  alternates: {
    canonical: "https://veridoctor.com/faq",
  },
};
